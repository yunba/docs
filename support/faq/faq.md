...
---
* 免费版每秒 20 条信息，超出后会怎样？
* 如果用户的使用量超出了免费版的限额，我们会提醒用户升级为付费服务。如果用户拒不接受，我们会在后台做出相应的使用限制。
---
...
---
* 在那些地区可以使用云巴的服务？
* 目前，云巴提供中国大陆、中国香港、东南亚及北美地区的接入服务，如需开通其他地区的接入服务，请联系我们的商务人员。
...
---
* 发送方怎样知道接收方收到了？
* 服务器收到第一条 PUBACK 时，会给发送方发一个 [RECVACK](http://yunba.io/docs2/socket.io_API/#recvack)。
...
---
* 用 Portal 和一个设备做测试时，“在线用户” 显示 2 个用户？
* 因为 Portal 本身也是一个用户。
...
---
* 使用什么版本的 Socket.IO-client？
* Node.js 请使用 0.9.17；Python 请使用 0.6.5。
